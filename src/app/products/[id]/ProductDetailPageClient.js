...
import { Heart, ShoppingCart, ShoppingBag, ChevronLeft, ChevronRight, ChevronDown, ArrowRight, Minus, Plus, Star, ShieldCheck, PenLine } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-12 w-full">
                        ...
                        <div className="w-full">
                            <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 w-full scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                                {productImages.map((image, index) => (
                                    ...
                                    >
                                        <div
                                            className={`relative w-20 h-20 rounded-lg overflow-hidden border-2 bg-gray-50 flex items-center justify-center ${selectedImage === index ? 'border-[#0B4866] ring-2 ring-[#0B4866]' : 'border-gray-200'
                                                }`}
                                        >
                                        ...
                                        <span
                                            className={`text-xs text-center max-w-[80px] line-clamp-2 ${selectedImage === index
                    ...
                    <div className="space-y-6 w-full overflow-hidden">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-[#0B4866] hover:underline cursor-pointer" onClick={() => setActiveTab('reviews')}>
                                {rating.toFixed(1)} / 5.0 ({reviews || 0} reviews)
                            </span>
                        </div>
                                            ...
                                            {allSizeOptions.map((variant) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-lg text-xs sm:text-sm font-medium border-2 ${isSelected
                                    ...
                                    <div className="px-4 pb-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                ...
                                                className={`relative inline-flex h-6 w-11 items-center rounded-full ${includeInstallation ? 'bg-[#0B4866]' : 'bg-gray-200'
                                                    }`}
                                            >
                                                <span
                                                    className={`inline-block h-4 w-4 rounded-full bg-white transition-transform ${includeInstallation ? 'translate-x-6' : 'translate-x-1'
                                                        }`}
                                                />
                                            </button>
                                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full">
                            ...
                            <button
                                ...
                                disabled={!displayProduct.inStock}
                                className={`w-full sm:flex-1 py-3 px-4 sm:px-6 rounded-lg font-medium flex items-center justify-center gap-2 text-sm sm:text-base ${!product.inStock
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 items-center">
                                        <div className="flex items-center gap-2">
                                            <label htmlFor="review-sort" className="text-sm font-medium text-gray-700 whitespace-nowrap">
                                                Sort by:
                                            </label>
                                            <select
                                                id="review-sort"
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    loadProductReviews(productId, e.target.value);
                                                }}
                                                className="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 focus:border-[#0B4866] focus:outline-none"
                                            >
                                ...
                                {productReviews && productReviews.length > 0 ? (
                                    <div className="space-y-6">
                                        {productReviews.map((review) => {
                                            ...
                                            const displayName = reviewerName || "Verified Customer";
                                            return (
                                                <div key={review.id} className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
                                                    <div className="flex flex-col gap-4">
                                                        <div className="flex items-center justify-between gap-3 flex-wrap">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                {review.isVerified && (
                                                                    <div className="flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full text-[10px] uppercase font-bold tracking-wider">
                                                                        <ShieldCheck size={12} />
                                                                        Verified Purchase
                                                                    </div>
                                                                )}
                                                        ...
                                                        <div className="space-y-2">
                                                            {review.title && (
                                                                <h4 className="text-lg font-bold text-gray-900 leading-tight">{review.title}</h4>
                                                            )}
                                                            {review.comment && (
                                                                <p className="text-sm leading-relaxed text-gray-700 whitespace-pre-line">
                                                                    {review.comment}
